...
; Disassembled Mon Mar 10 19:09:03 2025
...
;
; Below is the code for the original Parker Bros Frogger from 1982
; it was disassembled using distella with the included cfg to expand
; DATA sections. The cfg as it stand may not be correct. But the code
; here WILL assemble using dasm and should be playable in Stella or
; an original Atari 2600.
;
; NOTE: (instructions for building a cartridge are not yet included, but coming)
;
;
;
;
...
LFE15: .byte $FF ; |XXXXXXXX| $FE15
       ...
       .byte $06 ; |     XX | $FED5
       .byte $00 ; |        | $FED6
       .byte $03 ; |      XX| $FED7 ; Start of Background Pattern/Terrain sprites
       .byte $05 ; |     X X| $FED8
       .byte $05 ; |     X X| $FED9
       .byte $03 ; |      XX| $FEDA
       .byte $02 ; |      X | $FEDB
       ...
       .byte $07 ; |     XXX| $FEFF
       .byte $00 ; |        | $FF00
LFF01: ; === Number 0 Start ===
       .byte $1C ; |   XXX  | These numbers are probably the easiest to visualize
       ...
       .byte $5C ; | X XXX  |
       .byte $06 ; |     XX |
       .byte $82 ; |X     X | ; Start of Frog sprite facing DOWN
       .byte $92 ; |X  X  X |
       .byte $FE ; |XXXXXXX |
       .byte $38 ; |  XXX   |
       .byte $7C ; | XXXXX  |
       .byte $BA ; |X XXX X |
       .byte $92 ; |X  X  X | ; End of Frog sprite facing DOWN / Start of Frog sprite facing UP
       .byte $BA ; |X XXX X |
       .byte $7C ; | XXXXX  |
       .byte $38 ; |  XXX   |
       .byte $FE ; |XXXXXXX |
       .byte $92 ; |X  X  X |
       .byte $82 ; |X     X | ; End of Frog sprite facing UP / Start of Frog sprite facing RIGHT
       .byte $EE ; |XXX XXX |
       .byte $38 ; |  XXX   |
       .byte $7C ; | XXXXX  |
       .byte $7E ; | XXXXXX |
       .byte $7C ; | XXXXX  |
       .byte $38 ; |  XXX   |
       .byte $EE ; |XXX XXX | ; End of Frog sprite facing RIGHT / Start of Frog sprite facing LEFT
       .byte $77 ; | XXX XXX|
       .byte $1C ; |   XXX  |
       .byte $3E ; |  XXXXX |
       .byte $7E ; | XXXXXX |
       .byte $3E ; |  XXXXX |
       .byte $1C ; |   XXX  |
       .byte $77 ; | XXX XXX| ; End of Frog sprite facing LEFT
       .byte $42 ; | X    X | ; Start of Frog SPLAT sprite
       .byte $7E ; | XXXXXX |
       .byte $3C ; |  XXXX  |
       .byte $24 ; |  X  X  |
       .byte $42 ; | X    X |
       .byte $81 ; |X      X|
       .byte $88 ; |X   X   | ; Start of Log sprite (maybe snake?)
       .byte $58 ; | X XX   |
       .byte $7C ; | XXXXX  |
       .byte $25 ; |  X  X X|
       .byte $06 ; |     XX |
       ...
       .byte $38 ; |  XXX   |
       .byte $14 ; |   X X  |
       .byte $3C ; |  XXXX  | ; I think this is a turtle
       .byte $7E ; | XXXXXX |
       .byte $FF ; |XXXXXXXX|
       .byte $FF ; |XXXXXXXX|
       .byte $FF ; |XXXXXXXX|
       .byte $7E ; | XXXXXX |
       .byte $3C ; |  XXXX  |
       .byte $FD ; |XXXXXX X| ; Start of Second Vehicle/Car sprite (ai)
       .byte $DF ; |XX XXXXX|
       .byte $7F ; | XXXXXXX|
       .byte $FB ; |XXXXX XX|
       .byte $FF ; |XXXXXXXX|
       .byte $EF ; |XXX XXXX|
       .byte $FF ; |XXXXXXXX| ; Start of Third Vehicle/Bulldozer sprite (ai)
       .byte $C6 ; |XX   XX |
       .byte $00 ; |        |
       .byte $FF ; |XXXXXXXX|
       .byte $C7 ; |XX   XXX|
       ...
       .byte $00 ; |        |
       .byte $C6 ; |XX   XX |
       .byte $63 ; | XX   XX| ; Start of Fourth Vehicle/Race Car sprite (ai)
       .byte $00 ; |        |
       .byte $FF ; |XXXXXXXX|
       .byte $E3 ; |XXX   XX|
       .byte $FF ; |XXXXXXXX|
